    ...
    render() {
                    ...
                    <div className='form-group'>
                        <div className='input-group'>
                            ...
                            <span className='input-group-btn'>
                                <button className='btn btn-primary' style={{paddingTop: '3px', paddingBottom: '3px'}} onClick={() => this.props.onConfirm(this.promptInput.value)}>OK</button>
                            </span>
                        </div>
                    </div>
                </Popover> 
        ...
        return (
            <OverlayTrigger trigger='click' placement='top' overlay={denyReason}>
                <button className={this.props.buttonStyle}>{this.props.buttonText}</button>
            </OverlayTrigger>                               
        );        
    }
};
